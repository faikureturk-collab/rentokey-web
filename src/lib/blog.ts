...
export const posts: BlogPost[] = [
  {
    ...
    excerpt: "Yetki belgesi takvimini doğru okuyun; filo, kayıt ve depozito süreçleriniz için hazırlığa nereden başlayacağınızı belirleyin.",
    description: "2027 araç kiralama yönetmeliği için hazırlık rehberi: 1 Temmuz yetki belgesi süresi, filo koşulları ve işletmeler için kontrol listesi. Resmî kaynaklarla.",
    publishedAt: "2026-09-07",
    updatedAt: "2026-09-07",
    readingMinutes: 5,
    intro: [
      "Bir rent a car işletmesi için yeni bir düzenlemeye hazırlanmak, yalnızca dosya hazırlamak değildir. Filodaki araçları, ekipteki sorumlulukları ve müşteriye verilen bilgileri aynı planın içinde değerlendirmek gerekir.",
      "Bu rehber, yönetmeliğin bütün maddelerini tekrar etmek yerine **önce takvimi netleştirmeyi, ardından uygulanabilir bir hazırlık listesi oluşturmayı** amaçlıyor. Hukuki yükümlülüklerle işletme içi önerileri birbirinden ayırıyoruz.",
    ],
    body: [
      { type: "callout", title: "Kısa yanıt: 1 Temmuz 2027 neden önemli?", text: "Mevcut işletmelerin yetki belgesi alması için son tarih **1 Temmuz 2027**. Yürürlük tarihi ise **1 Ocak 2027**. Bu ayrım [Ticaret Bakanlığı açıklamasında](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi) belirtiliyor." },
      { type: "h2", id: "gecis-takvimi", text: "1. Önce geçiş takvimini doğru okuyun" },
      { type: "table", head: ["Tarih", "Anlamı"], rows: [
        ["1 Ocak 2027", "Yönetmeliğin yürürlüğe girişi"],
        ["1 Temmuz 2027", "Mevcut işletmelerin yetki belgesi alması için son tarih"],
        ["1 Ocak 2028", "Mevcut işletmeler için belirli filo şartlarına ilişkin geçiş süresinin sonu"],
      ] },
      { type: "p", text: "Kaynak: [Ticaret Bakanlığı — geçiş takvimi](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi). **2028 tarihi bütün yükümlülüklerin ertelendiği anlamına gelmez.** İşletmenize uygulanacak geçiş koşullarını ayrıca teyit edin." },
      { type: "p", text: "Hazırlık planını son başvuru gününden geriye doğru değil, eksiklerin tamamlanması için gereken süreden ileriye doğru kurmak daha sağlıklı. Bir belgeyi beklerken diğer kontrolleri durdurmayın; her başlığın sorumlusunu ve hedef tarihini ayrı belirleyin." },
      { type: "h2", id: "yetki-belgesi", text: "2. Yetki belgesi için bir hazırlık dosyası açın" },
      { type: "p", text: "Oda ve vergi kaydı, iş yeri koşulları ve mesleki yeterlilik, Bakanlığın açıkladığı başlıklar arasında. [Yetki belgesi açıklaması](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi)." },
      { type: "ul", items: ["Mevcut kayıtlarınızı tek dosyada toplayın; eksik ve güncellenecek bilgileri ayırın.", "İl Ticaret Müdürlüğünden kendi işletmeniz ve varsa şubeleriniz için koşulları öğrenin.", "Her eksik için bir sorumlu ve tamamlanma tarihi belirleyin.", "Başvuru hazırlığı ile belgenin alınmasını ayrı takip edin; dosyayı göndermeyi sürecin sonu saymayın."] },
      { type: "h2", id: "filo-kontrolu", text: "3. Araç sayısını değil, araç bazlı hazırlığı kontrol edin" },
      { type: "p", text: "Klasik taşıt istisnasıyla 6 yaş; genel olarak 180.000, elektrikli taşıtlarda 300.000 kilometre sınırı açıklanıyor. Asgari filo ve tescil koşulları konuma göre değişiyor. [Ticaret Bakanlığı — filo koşulları](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi)." },
      { type: "p", text: "Örneğin 70 araçlık filoda toplam sayının yüksek olması, hazırlık çalışmasının bittiğini göstermez. Güncel kilometre bilgisi eksikse hangi araca önce bakacağınızı da bilemezsiniz. Aşağıdaki tabloyu araç bazında hazırlamanızı öneriyoruz; bu bir mevzuat şartları listesi değil, iç kontrol yöntemidir." },
      { type: "table", head: ["Kontrol alanı", "Hazırlık sorusu"], rows: [
        ["Yaş ve kilometre", "Bilgi güncel mi; hangi araç önce inceleme gerektiriyor?"],
        ["Tescil ve araç türü", "Filo bileşimini tek listede görebiliyor muyuz?"],
        ["Bakım, muayene ve sigorta", "Yaklaşan tarihler için kim aksiyon alacak?"],
        ["Yenileme planı", "Değişim gerekiyorsa bütçe ve rezervasyon planı hazır mı?"],
      ] },
      { type: "p", text: "Amaç bütün filoyu bir anda değiştirmek değil, karar gerektiren araçları erkenden ayırmak. Böylece araç yenileme kararını mevcut rezervasyonlardan koparmadan değerlendirebilirsiniz." },
      { type: "h2", id: "operasyon-kayitlari", text: "4. Teslim, iade ve depozito akışını birlikte gözden geçirin" },
      { type: "p", text: "Depozito üst sınırı 1–6 günlük kiralamalarda üç, 7–29 günlük kiralamalarda yedi günlük kira bedeli olarak açıklanıyor. [Ticaret Bakanlığı — depozito açıklaması](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi)." },
      { type: "p", text: "Operasyonel önerimiz, kira bedeli, açık bakiye ve depozitoyu birbirine karıştırmadan takip etmek. Teslimi yapan kişiyle iadeyi alan kişi farklı olduğunda da kayıt anlaşılır kalmalı. Müşteriye hangi bilginin verildiği ve bekleyen işlemi kimin tamamlayacağı görünür olmalı." },
      { type: "p", text: "Ekibinizle örnek bir rezervasyonu baştan sona yürütün: müşteri talebi, araç atama, teslim hazırlığı, ödeme kontrolü ve iade. Her aşamada bilginin nerede tutulduğunu sorun. Cevap yalnızca bir personelin telefonundaysa, sürecin ortak kayda ihtiyacı vardır. [Teslim/iade süreçleri üzerine yazımız](/blog/arac-teslim-iade-surecini-dijitallestirmek) bu çalışma için tamamlayıcı bir başlangıç olabilir." },
      { type: "h2", id: "hazirlik-listesi", text: "5. Bugün başlayabileceğiniz hazırlık listesi" },
      { type: "ol", items: ["Faaliyetinizin kapsamını ve size uygulanacak geçiş hükümlerini netleştirin.", "Yetki belgesi hazırlığı için bir sorumlu belirleyin.", "Filo envanterindeki eksik bilgileri tamamlayın.", "Sözleşme ve teslim/iade şablonlarını uzmanınıza inceletin.", "Depozito ve açık bakiye takibindeki sorumlulukları ayırın.", "Örnek bir rezervasyonla ekip içi akışı test edin."] },
      { type: "p", text: "RentOkey’de filo, rezervasyon, bakım ve ödeme bilgilerini birlikte takip etmek bu hazırlıkta düzen sağlamaya yardımcı olabilir. **Yazılım kullanımı tek başına mevzuata uygunluk sağlamaz.** İşletmeye özel şartlar ve belgeler ayrıca değerlendirilmelidir." },
      { type: "h2", id: "sik-sorulanlar", text: "Sık sorulan sorular" },
      { type: "h3", text: "Temmuz tarihini bekleyerek hazırlığa başlayabilir miyim?" },
      { type: "p", text: "Hazırlığı son tarihe bırakmanızı önermiyoruz. Yukarıdaki takvimde yürürlük ve geçiş tarihleri farklı amaçlara hizmet ediyor. Eksiklerinizi şimdiden belirleyip ilgili idareyle netleştirmek daha güvenli bir plan sağlar." },
      { type: "h3", text: "Her kiralama aynı kapsamda mı?" },
      { type: "p", text: "Hayır. Bakanlık uzun süreli kiralamaları, tüketici dışındaki kısa süreli kiralamaları ve kamp taşıtlarını kapsam dışında açıklıyor. [Kapsam açıklaması](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi)." },
      { type: "h3", text: "Bu rehberi KKTC operasyonum için kullanabilir miyim?" },
      { type: "p", text: "Hazırlık yöntemlerinden yararlanabilirsiniz; ancak Türkiye’deki bu takvimi KKTC için bir yasal yükümlülük takvimi olarak kullanmayın. Yerel koşulları ilgili makamlarla ayrıca değerlendirin." },
      { type: "h2", id: "resmi-kaynaklar", text: "Kaynaklar ve son kontrol" },
      { type: "ul", items: ["[Ticaret Bakanlığı — Aydın Ticaret İl Müdürlüğü açıklaması](https://aydin.ticaret.gov.tr/haberler/ticaret-bakanligi-kiralik-araclarda-yetki-belgesi-arac-yasi-ve-kilometresi-depozito-tuketici-haklari-ve-filo-standartlarini-yeniden-duzenlendi)", "[Resmî Gazete — Motorlu Kara Taşıtlarının Kiralanması Hakkında Yönetmelik](https://www.resmigazete.gov.tr/eskiler/2026/08/20260815-1.htm) — Bakanlık açıklamasının yönlendirdiği resmî metin."] },
      { type: "callout", title: "Editör notu · RentOkey · 7 Eylül 2026", text: "Bu rehber Bakanlığın açıklamasına dayanan genel bilgilendirme ve işletme içi hazırlık önerileridir; hukuki görüş değildir. Uygulama öncesinde güncel resmî metni ve işletmenize özel koşulları ilgili idare veya hukuk danışmanınızla teyit edin." },
    ],
  },
  {

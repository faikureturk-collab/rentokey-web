    ...
    <footer className="bg-brand-navy-deep text-white">
      <div className="container-page py-14">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(12.5rem,1.25fr)]">
          ...
          <FooterColumn title={en ? "Product" : "Ürün"} links={en ? [{label:"Car rental software",href:"/en/car-rental-software"},{label:"Reservation calendar",href:"/en/car-rental-reservation-calendar"},{label:"Reporting and fleet analytics",href:"/en/car-rental-reporting-and-fleet-analytics"},{label:"Operations platform",href:"/en#product"},{label:"RentOkey Pilot",href:"/en/pilot"},{label:"2027 compliance (Türkiye)",href:"/en/turkey-car-rental-regulation-2027"},{label:"Pricing",href:"/en/pricing"},{label:"Start free trial",href:"/en/free-trial"}] : footerNav.urun} />
          <FooterColumn title={en ? "Resources" : "Kaynaklar"} links={en ? [{label:"FAQ",href:"/en#faq"},{label:"Data migration",href:"/en#how-it-works"},{label:"Blog",href:"/en/blog"}] : footerNav.kaynaklar} />

...
const tabs: Tab[] = [
  {
    ...
    description: "Rezervasyonları araç ve tarih ekseninde yönetin. Boş günleri görün, sistemin uygun araç önerisini değerlendirin ve gerektiğinde rezervasyonu sürükleyip başka araca taşıyın.",
  ...
  },
  {
    ...
    description: "Günün teslim ve iadeleri saat sırasına göre tek kuyrukta görünür. Her işlem, bulunduğu aşamaya uygun ve kolay fark edilen aksiyonla ilerler.",
  ...
  },
  {
    ...
    description: "Ödenen ve bekleyen tutarları rezervasyonlarla birlikte takip edin. Giderleri kayıt altına alın ve performansı dönemler arasında karşılaştırın.",

    ...
    <section id={en ? "pilot" : "okey-pilot"} className="scroll-mt-24 bg-brand-navy-deep text-white">
      <div className="container-page grid gap-8 py-14 lg:grid-cols-[.85fr_1.15fr] lg:items-center sm:py-20">
        <div>
          ...
          <p className="mt-5 text-base leading-relaxed text-white/70">{en ? "Pilot evaluates vehicles, reservations, maintenance and preparation windows together, then suggests an optimised plan for current conditions. Smart pricing suggestions are also included." : "Araç, rezervasyon, bakım ve hazırlık sürelerini birlikte değerlendirir; mevcut koşullara göre optimize edilmiş bir plan sunar. Akıllı fiyat önerisi de Pilot kapsamındadır."}</p>

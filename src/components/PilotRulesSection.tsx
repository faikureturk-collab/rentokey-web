          ...
          <div className="overflow-hidden rounded-[28px] bg-brand-navy-deep p-7 text-white sm:p-10">
            <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-white/65">{en ? "The free-text operations simulator is planned as the next Pilot capability. It will explain which reservations, vehicles and preparation windows may be affected before a change is made." : "Serbest metin operasyon simülatörü, Pilot’ın sıradaki yeteneği olarak planlanıyor. Bir değişiklik yapılmadan önce hangi rezervasyonların, araçların ve hazırlık sürelerinin etkilenebileceğini açıklayacak."}</p>
              </div>

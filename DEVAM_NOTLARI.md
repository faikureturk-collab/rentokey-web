...
`/ucretsiz-dene` sayfası iki adımlı anında onboarding arayüzüne dönüştürüldü. İlk adım hesap, ikinci adım firma/filo bilgilerini topluyor; Türkiye ve KKTC seçenekleri, mobil uyum, şifre görünürlüğü, sözleşme onayı ve tamamlanma ekranı eklendi. Form şu anda ön yüz prototipidir; gerçek kullanıcı ve firma kaydı oluşturması için Rent Okey uygulamasının kimlik/tenant oluşturma servisine bağlanması gerekir.
